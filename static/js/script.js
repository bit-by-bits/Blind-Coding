    ...
    success: function (jsondata) {
      ...
      for (var i = 0; i < objRecieved.username.length; ++i) {
        ...
        document.getElementsByClassName("name")[i + 2].innerHTML =
          objRecieved.username[i]; //Get Array of Username's here
        document.getElementsByClassName("score")[i + 2].innerHTML =
          objRecieved.score[i]; //Get Array of Score's here
      }
      document.getElementById("userRank").innerHTML =
        "Your Rank : " + objRecieved.rank;
